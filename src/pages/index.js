...
export default function Index({ posts }) {
  return (
    <>
      <Head>
        <title>Nexus - Maria Gouveli</title>
        <meta property="og:title" content="Nexus - Maria Gouveli" key="home" />        
        <meta property="og:description" content="This is an art project without clear dividing lines between artwork, research, social engagement and documentation. Like a plexus, it is an interwoven combination of elements in one structure.All elements are correlated and mingled in a dynamic mapping process." />        
        <meta property="og:image" content="https://next.mariagouveli.com/about/cover.jpg" />
      </Head>
