          ...
          {links.map((link, index) => (   
            <g key={index}>
              {link.data.location && <g>            
                <motion.circle ref={circleRef} cx="10" cy="10" r="21"
                  initial={{ opacity: 0, r: 30 }} animate={{ opacity: 1, r: 21, transition: { default: { delay: 0.5 + (index / 4), duration: 0.5, ease: "easeOut" } } }}
