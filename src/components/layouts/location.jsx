    ...
    <motion.div className="relative" >
      ...
      <div className="lg:flex">
        ...
        <div className="lg:w-1/3 relative  fixed -top-10 left-0 z-10 ">
          <div className=" pl-8 max-w-2xl lg:pr-0 pr-8 pt-32 w-full relative top-0 left-0 ">   
        ...
        <div className="lg:w-2/3 relative  pl-12 pr-16 bg-white dark:bg-gray-950 z-20" key={data.color}>
